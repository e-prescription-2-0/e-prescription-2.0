...
const ForgotPasswordForm = () => {
  ...
  const renderForgotPasswordStep = useCallback(() => {
    ...
    const backOnClick = () => setForgotPasswordStep(forgotPasswordStep - 1);
  ...
  return (
    <>
      <Form noValidate validated={validated} onSubmit={handleSubmit} className={style["form-forgot-password"]}>
